...
"""
Utility functions for manipulating image data and generating adversarial examples. 
It includes functions to load model weights, apply random transformations to images, etc.
...
def lab_attack(X_nat, c_trg, model, epsilon=0.05, iter = 100):
    ...
    pert_a = (torch.ones(X_nat.shape[0], 2, X_nat.shape[2], X_nat.shape[3]) * 0.01).cpu().requires_grad_()
