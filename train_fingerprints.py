...
import fingerprint_models


"""
Trains a StegaStamp model to embed and extract a binary fingerprint from images. 
...
def main():
    ...
    load_data()
    encoder = fingerprint_models.StegaStampEncoder(
        args.image_resolution,
        IMAGE_CHANNELS,
        args.fingerprint_length,
        return_residual=False,
    )
    decoder = fingerprint_models.StegaStampDecoder(
        args.image_resolution,
        IMAGE_CHANNELS,
        args.fingerprint_length,
    )
        ...
        for images, _ in tqdm(dataloader):
            ...
            if global_step in plot_points:
                ...
                save_image(
                    ...
                    SAVED_IMAGES + "/{}.jpg".format(global_step),
                    normalize=True,
                )
